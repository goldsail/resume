    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Workflow systems and distributed observability systems}{
          \begin{itemize}
            \item I work on internal systems that power the ordering, payment, fulfillment workflows across Amazon retail business.
            \item I develop automatic tracing and observability of a distributed business process, which is integrated to the retail website.
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Full-stack development of a new Web App for workflow visualization}{
          \begin{itemize}
            \item I worked on a \textbf{React} web app for Amazon's workflow orchestration system used by 900+ internal teams.
            \item I implemented the workflow visualization using \textbf{ReactFlow}, with customized graph layout and rendering.
            \item I root caused performance bottlenecks and pushed table size from 1000 to 2500, graph size from 300 to 1200.
            \item Experienced authentication \& authorization, CSRF protection, Infrastructure as Code and tier-1 operations.
          \end{itemize}
        }
      \resumeItemListEnd
      }
