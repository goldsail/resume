...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://github.com/goldsail}{https://github.com/goldsail} $\mid$ seeking full time SDE jobs & Mobile: +1-858-247-6514 \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science in Computer Science; GPA 3.9;}{Aug. 2019 -- expected Dec. 2020}
    \resumeSubheading
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Amazon; Consumer Division}{Seattle, WA}
      {SDE Intern in Orchestration Team}{Jun 2020 -- Sep 2020}
      \resumeItemListStart
        \resumeItem{Micro-services Data Summarization}{
          \begin{itemize}
            ...
            \item I built a web portal in \textbf{Angular JS} to present persisted data. Also generated weekly reports.
            \item Deployed serverless as \textbf{AWS Lambda} and \textbf{Step Functions}.
          \end{itemize}
        }
      \resumeItemListEnd
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Languages and Tools}{: C/C++, Go, JavaScript, Java, R, Python, C\#, MATLAB, Bash, Git, AWS}
      }
    \item{
      \textbf{Frameworks}{: ReactJS, Ant Design, Thrift (RPC), Gin, Guice, DynamoDB, MySQL, Redis, Kafka, Qt}
    }
  \resumeSubHeadingListEnd
