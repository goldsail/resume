      ...
      \resumeItemListStart
        \resumeItem{Content Management System}{
          \begin{itemize}
            ...
            \item Full-stack in ReactJS and Go, using Redis, Kafka, consul, Kite, Ant Design, etc.
          \end{itemize}
        }
        \resumeItem{Stock Quotation Monitor}{
          \begin{itemize}
            ...
            \item Saved other developer's time in fixing wrong quotation data by fixing data automatically.
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Languages}{: C++, Go, JavaScript, Java, R, Python, C\#, MATLAB}
      \hfill
